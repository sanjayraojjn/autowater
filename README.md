...
There are some prerequisites to run this code:

- ESP32 board
- ESP32 compatible capacitance based soil moisture sensor
- ESP32 compatible small 5v submersible pump
- ESP32 compatible relay - 1
